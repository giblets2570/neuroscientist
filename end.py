...
def funcs(dataset, rec_network, auto_network, batch_size=BATCH_SIZE, learning_rate=LEARNING_RATE, momentum=MOMENTUM, sparsity=0.01,beta=0.00005,alpha=L2_CONSTANT,auto_frac=0.9):
    ...
    cost = (1-auto_frac) * (beta * L + auto_cost) + (1+auto_frac) * rec_cost  #+ alpha * l2
